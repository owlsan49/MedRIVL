        ...
        with open(output_file_name, 'w') as out:
            ...
            for item in data:
                ...
                try:
                    ...
                    out.write(
                        question_id + '\t' + img_id + '\t' + question + '\t' + confident_ans + '\t' + object_name + '\t' + refers + '\t' + distances + '\t' + base64_str + '\n')

                    index += 1

                    # if mode == 'train_val':
                    if ans not in ans2label.keys():
                        print("add answer '{}' into the ans2label dic. Now we have {} answers.".format(ans,
                                                                                                       len(ans2label)))
