...
from src.pmc_clip.timm_model import TimmModel
from src.pmc_clip.utils import freeze_batch_norm_2d, to_2tuple
...
class PMC_CLIP(nn.Module):
    def __init__(
        ...
        if text_cfg.bert_model_name:
            ...
            tokenizer_name = r'C:\Users\LuoShang\Downloads\BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext'
            # assert text_cfg.bert_model_name == 'microsoft/BiomedNLP-BiomedBERT-base-uncased-abstract-fulltext', \
    ...
    def encode_text(self, batch, image_features):
        ...
        if last_token_index.shape == torch.Size([1, 1]):
